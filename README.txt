...
![Python](httpsimg.shields.iobadgePython-3.8-bluestyle=flat-square&logo=python) ![Tkinter](httpsimg.shields.iobadgeGUI-Tkinter-orangestyle=flat-square) ![Status](httpsimg.shields.iobadgeStatus-In%20Development-yellowstyle=flat-square)
...
- [x] Portfolio persistence (JSON loadsave)
...
- Live Stock Charts — real-time price data via YFinance with MA20MA50 overlays and volume
...
```bash
git clone httpsgithub.comAhmedGElnaggarQuant-analysis.git
cd Quant-analysis
...
Ahmed Elnaggar — [GitHub](httpsgithub.comAhmedGElnaggar)
